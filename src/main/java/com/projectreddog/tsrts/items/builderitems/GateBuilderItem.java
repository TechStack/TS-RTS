...
public class GateBuilderItem extends BuilderItem {
	...
	public GateBuilderItem() {
		super(new Item.Properties().group(ModItemGroups.weaponsItemGroup));
		setRegistryName(Reference.REIGSTRY_NAME_GATE_BUILDER_ITEM);
	}
	...
	public float getTotalStructureHealth() {
		return Config.CONFIG_STRCTURE_TOTAL_HEALTH_GATE.get();
	}
