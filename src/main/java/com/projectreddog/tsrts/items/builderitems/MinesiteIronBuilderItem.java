...
public class MinesiteIronBuilderItem extends BuilderItem {
	...
	private ResourceLocation templateName100 = new ResourceLocation(Reference.MODID + ":" + "iron_red_2");
	private ResourceLocation templateName50 = new ResourceLocation(Reference.MODID + ":" + "iron_red_2");
	private ResourceLocation templateName0 = new ResourceLocation(Reference.MODID + ":" + "iron_red_2");
