...
public class Reference {
	...
	public static enum RTS_COSTS {
		MINION, ARCHER, LANCER, PIKEMAN, FARM, LUMBER_YARD, MARKETPLACE, MINE_STONE, MINE_IRON, MINE_GOLD, MINE_DIAMOND, MINE_EMERALD, BARRACKS, ARCHERY_RANGE, WALL, WALL_STEPS, GATE, RESEARCH_CENTER, STABLES, WATCH_TOWER, RESEARCH_TOWNHALL, RESEARCH_MINION, RESEARCH_ARCHER, RESEARCH_PIKEMAN, RESEARCH_LANCER, RESEARCH_ARMORY, RESEARCH_MARKETPLACE, RESEARCH_WALL, RESEARCH_SIEGE_WORKSHOP, RESEARCH_CROSSBOW, RESEARCH_ADVANCED_ARMOR, RESEARCH_WATCHTOWER, RESEARCH_BATTERING_RAM, RESEARCH_TREBUCHET, SIEGE_WORKSHOP
	}
