...
public class SiegeWorkshopBlock extends OwnedBlock {

	public SiegeWorkshopBlock() {
		super(Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2.0f));
		setRegistryName(Reference.REIGSTRY_NAME_SIEGE_WORKSHOP_BLOCK);
	}
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		...
		return new SiegeWorkshopTileEntity();
	}
