...
public class LumberYardBlock extends OwnedBlock {

	public LumberYardBlock() {
		super(Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2.0f));
		setRegistryName(Reference.REIGSTRY_NAME_LUMBER_YARD_BLOCK);
	}
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		...
		return new LumberYardTileEntity();
	}
